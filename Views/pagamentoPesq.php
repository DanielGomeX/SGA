    ...
    <div class="box-body">
        ...
        <form action="../controllers/editarPagamento.php" method="POST"  align='middle'>
            <div class="form-group">
                ...
                <input readonly="true" required="required" class="form-control" type="text"
            ...
            <div class="form-group">
                ...
                <input readonly="true" required="required" type="text" class="form-control"
                       id="mesreferente" name="mesreferente" value="<?php echo $user['mes_referente']; ?>"/>
            </div>
            <div class="form-group">
                <label for="dtvencimento">Data de vencimento</label></br>
                <input  disabled="disable" required="required" type="radio" id="dtvencimento" name="dtvencimento" value="dia 5" <?php if ($user['dt_vencimento'] == 'dia 5') {
    echo "checked";
} ?>/>Dia 5</br>
                <input disabled="disable" readonly="true" type="radio" id="dtvencimento" name="dtvencimento" value="dia 10" <?php if ($user['dt_vencimento'] == 'dia 10') {
    echo "checked";
} ?>/>Dia 10</br>
                <input disabled="disable" readonly="true" type="radio" id="dtvencimento" name="dtvencimento" value="dia 15"<?php if ($user['dt_vencimento'] == 'dia 15') {
    echo "checked";
} ?>/>Dia 15</br>
            </div>
